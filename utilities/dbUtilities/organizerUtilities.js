...
const findOrganizerByNameOrPhone = async (organizerName, phoneNumber, excludeId = null, db) => {
  try {
    let query = "SELECT * FROM organizerData WHERE (organizerName = ? OR phoneNumber = ?)";
